...
<script setup>
    ...
    const data = new DataManager({
        url: 'https://localhost:7008/api/Grid',
        insertUrl: 'https://localhost:7008/api/Grid/Insert',
        updateUrl: 'https://localhost:7008/api/Grid/Update',
        removeUrl: 'https://localhost:7008/api/Grid/Remove',
